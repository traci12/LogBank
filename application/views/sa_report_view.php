...
<title>LOGBANK - STAFF ACTIVITY LOG RECORD</title>
<?php 
            ...
            <div class="maincontentinner">
                <div class="row-fluid">
					<div class="tabbedwidget tab-primary">
                            <ul>
                                <li><a href="#a-3">Staff Activity Report</a></li>
                            </ul>
                            
							<!--tab1 vistor log book -->
							
                            <div id="a-3">
                                <h4 class="widgettitle">Staff Activity Report</h4>
                ...
                <div class="widgetcontent wc1">
                    <?=form_open('sa_report')?>
                            <div class="par control-group">
                                    <label class="control-label" for="firstname">Staff</label>
                                <div class="controls">
							       <?php 
                                    $options=array();
