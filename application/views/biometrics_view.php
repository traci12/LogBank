...
<title>LOGBANK - ATTENDANCE</title>
<?php 
    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">   
            ...
            <ul class="nav nav-tabs nav-stacked">
				...
				<li class="active"><a href="biometrics"><span class="iconfa-laptop"></span> Attendance</a></li>
				...
				<li><a href="my_attendance"><span class="iconfa-th-list"></span> My Daily Time Record</a></li>
				<li><a href="my_activity"><span class="iconfa-th-list"></span> My Activity</a></li>
				<li class="active"><a href="my_visitors.php"><span class="iconfa-th-list"></span> My Visitors</a></li>
				<?php }?>
    ...
    <div class="rightpanel">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                <div class="row-fluid">
				<div id="clock"></div>
				<iframe src='attendance' width='100%' height='250px'/>
				</div><!--row-fluid-->
